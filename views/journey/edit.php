...
$id_journey = (int)$_GET['id'];

if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $journeyController->update($id_journey);
}

$data = $journeyController->edit($id_journey);
$journey = $data['journey'];
$umkm_list = $data['umkm_list'];
...
<head>
    ...
    <title>Edit Journey - UMKM Gandoang</title>
            ...
            <div class="content">
                <div class="form-container">
                    <div class="form-header text-center mb-4">
                        <h3 class="form-title">Form Edit Journey</h3>
                    </div>
                    ...
                    <div class="mb-4 text-secondary">
                        ...
                        <div class="d-flex mb-1">
                            <span class="fw-bold" style="width: 100px;">Nama Umkm</span>
                            <span>: <?= htmlspecialchars($journey['nama_umkm']) ?></span>
                        </div>
                    </div>

                    <form action="edit.php?id=<?= $id_journey ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <div class="d-flex">
                                    ...
                                    <textarea name="deskripsi" id="deskripsi" class="form-control" rows="4" required><?= htmlspecialchars($journey['deskripsi']) ?></textarea>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <select name="id_umkm" id="id_umkm" class="form-select w-auto" required>
                                        <?php foreach($umkm_list as $umkm): ?>
                                            <option value="<?= $umkm['id_umkm'] ?>" <?= ($umkm['id_umkm'] == $journey['id_umkm']) ? 'selected' : '' ?>>
