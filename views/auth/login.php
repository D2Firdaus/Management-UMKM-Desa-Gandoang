    ...
    <div class="main">
        <div class="card">
            ...
            <?php if (isset($_SESSION['success'])): ?>
                <div style="background:#e0ffe0;color:#060;padding:0.6rem;border-radius:6px;font-size:0.8rem;margin-bottom:1rem;text-align:center;"><?= htmlspecialchars($_SESSION['success']);
